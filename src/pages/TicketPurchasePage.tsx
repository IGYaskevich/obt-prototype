...
export default function TicketPurchasePage() {
  ...
  const { company, selectedFlight, employees, getEmployeeById, employeeHasValidDocs, travelPolicy, addTrip } =
    useStore()
      ...
      <div className="card p-4 grid md:grid-cols-3 gap-4 text-sm">
        ...
        <div className="space-y-1 text-xs text-slate-600">
          ...
          <div>
            ...
            <span className="font-medium">{totalAmount.toLocaleString('ru-RU')} KZT</span>
          </div>
        ...
        <div className="text-xs text-slate-500 flex items-start gap-2">
          ...
          <span>
            Policy thresholds are configured by admin in Company Settings. If flight is BLOCK, you cannot complete
            purchase in this prototype.
          </span>
        </div>
      </div>
        ...
        <div className="border-l border-slate-100 pl-0 md:pl-4 md:ml-4 text-xs flex flex-col justify-between">
          <div className="space-y-2">
            ...
            <div className="mt-2 text-[11px] text-slate-500">
              Closing documents: <strong>{closingDocsAvailable ? 'will be generated' : 'not available'}</strong> (
            ...
            {flightPolicy === 'BLOCK' && (
              <div className="mt-2 text-[11px] text-red-600 flex items-start gap-1">
                ...
                <span>
                  This flight is blocked by travel policy. In this prototype purchase is disabled for BLOCK options.
                </span>
              </div>
            )}
          </div>
