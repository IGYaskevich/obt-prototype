...
export default function SearchPage() {
    ...
    return (
        <div className="space-y-6">
            <SectionHeader
                title="Search trips"
                subtitle="Search flights, rail, hotels and transfers with company policies and tariff applied"
            />
            ...
            <div className="card p-2 flex items-center justify-between gap-4">
                ...
                <div className="text-[11px] text-slate-500">
                    This is a demo search screen — results are mocked for all types.
                </div>
            </div>
    ...
    return (
        <div className="card p-4 space-y-4">
            ...
            <div className="grid md:grid-cols-[1.2fr_1.2fr_auto] gap-3 items-end">
                ...
                <button
                    type="button"
                    className="btn-ghost h-9 mt-5 flex items-center justify-center"
                    onClick={handleSwap}
                >
                    <Plane size={16} />
                </button>
            ...
            <div className="grid md:grid-cols-2 gap-3">
                <div>
                    ...
                    <input
                        ...
                        placeholder="Client meeting, internal workshop, conference…"
                    />
                </div>
    ...
    return (
        <div className="card p-4 space-y-4">
            ...
            <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-3 pt-2 border-t border-slate-100 mt-2">
                <div className="text-[11px] text-slate-500">
                    {tariffLabel ||
                        'Rail trips follow the same company policy and tariff as flights (limits and approvals).'}
                </div>
                <button
                    type="button"
                    className="btn-primary self-end"
    ...
    return (
        <div className="card p-4 space-y-4">
            ...
            <div className="grid md:grid-cols-3 gap-3">
                ...
                <div>
                    ...
                    <input
                        ...
                        value={rooms}
                        onChange={e =>
                            setRooms(Math.max(1, Math.min(5, Number(e.target.value) || 1)))
                        }
                    />
                </div>
                <div>
            ...
            <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-3 pt-2 border-t border-slate-100 mt-2">
                <div className="text-[11px] text-slate-500">
                    {tariffLabel ||
                        'Hotel limits (nightly price, stars) are applied according to your company policy.'}
                </div>
                <button
                    type="button"
                    className="btn-primary self-end"
        ...
        <div className="card p-4 space-y-4">
            ...
            <div className="grid md:grid-cols-3 gap-3">
                ...
                <div>
                    ...
                    <input
                        ...
                        value={pax}
                        onChange={e =>
                            setPax(Math.max(1, Math.min(6, Number(e.target.value) || 1)))
                        }
                    />
                </div>
            </div>
            ...
            <div className="grid md:grid-cols-2 gap-3">
                ...
                <div className="text-[11px] text-slate-500 flex items-end">
                    {tariffLabel ||
                        'Transfer bookings can be grouped with flights and hotels into a single business trip.'}
                </div>
            </div>

            <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-3 pt-2 border-t border-slate-100 mt-2">
                <div className="text-[11px] text-slate-500">
                    Pickup times and vehicle types will be shown on the next screen with mocked options.
                </div>
                <button
                    type="button"
                    className="btn-primary self-end"
...
function TabButton({
    ...
    return (
        <button
            type="button"
            className={
                'flex items-center gap-1 px-3 py-1 rounded-full transition ' +
        ...
        <div className="flex flex-col justify-between text-xs text-slate-600 md:items-end">
            <div className="mt-4 md:mt-0">
                <div className="flex items-center gap-1 justify-end">
                    ...
                    <span className="badge-brand uppercase tracking-wide">
            {company?.tariff ?? 'FREE'}
          </span>
                </div>
                {tariffLabel && (
                    <div className="text-[11px] text-right text-slate-500 mt-1">
                        {tariffLabel}
                    </div>
                )}
            </div>
