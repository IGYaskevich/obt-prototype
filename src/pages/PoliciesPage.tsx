        ...
        <div className="flex items-start gap-2">
          ...
          <div>
            ...
            <div className="text-xs text-slate-600 mt-1">
              These rules are configured by admin in Company Settings. Coordinators see their effect in search results
              and booking flows as OK / WARN / BLOCK flags.
            </div>
          </div>
        </div>
      ...
      <div className="card p-4 space-y-3 text-sm">
        ...
        <div className="grid md:grid-cols-3 gap-4 text-xs">
          ...
          <div className="flex items-start gap-2 text-[11px] text-slate-600">
            ...
            <span>
              These thresholds are applied per one-way flight. For round trips, system evaluates segment prices
              separately or combined (depending on configuration).
            </span>
          </div>
        </div>
      </div>
      ...
      <div className="card p-4 space-y-3 text-sm">
        ...
        <div className="grid md:grid-cols-3 gap-4 text-xs">
          ...
          <div className="text-[11px] text-slate-600 md:col-span-2">
            This helps steer employees towards business-friendly departure times (e.g. avoid night flights) without
            fully blocking out-of-window options.
          </div>
        </div>
      </div>
        ...
        <div className="space-y-2">
          ...
          <div className="text-xs text-slate-600 space-y-1">
            ...
            <div className="text-[11px] text-slate-500 mt-1">
              These rules are applied on top of price and time logic and are reflected in flight badges and detailed
              tooltips in search results.
            </div>
          </div>
        </div>
      </div>
