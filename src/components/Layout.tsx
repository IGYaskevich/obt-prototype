    ...
    <div className="min-h-screen grid md:grid-cols-[260px_1fr]">
      <aside className="hidden md:flex flex-col bg-white border-r border-slate-100 p-4">
        <Link to="/dashboard" className="flex items-center gap-2 px-2 py-2">
          <div className="h-9 w-9 rounded-xl bg-brand-500 text-white flex items-center justify-center font-bold">OBT</div>
        ...
        <header className="sticky top-0 z-10 bg-white border-b border-slate-100">
          <div className="container-page h-14 flex items-center justify-between">
            <div className="md:hidden flex items-center gap-2">
              <div className="h-8 w-8 rounded-lg bg-brand-500 text-white flex items-center justify-center font-bold text-xs">OBT</div>
              <div className="text-sm font-semibold">OBT Prototype</div>
            </div>
            <div className="flex items-center gap-3">
              <span className="badge-brand">Tariff: {company.tariff}</span>
              <button onClick={() => navigate('/tariffs')} className="btn-ghost">Change tariff</button>
            </div>
          </div>
        </header>
