...
export default function TravelPolicyPage() {
    ...
    return (
        <div className="space-y-6">
            <SectionHeader
                title="Travel policy"
                subtitle="Read-only view of current company travel rules used in search and booking flows."
            />
                ...
                <div className="flex items-start gap-2">
                    ...
                    <div>
                        ...
                        <div className="text-xs text-slate-600 mt-1">
                            These rules are configured by admin in Company Settings. Coordinators see their effect
                            in search results and booking flows as OK / WARN / BLOCK flags.
                        </div>
                    </div>
                </div>
            ...
            <div className="card p-4 space-y-3 text-sm">
                ...
                <div className="grid md:grid-cols-3 gap-4 text-xs">
                    ...
                    <div className="flex items-start gap-2 text-[11px] text-slate-600">
                        ...
                        <span>
              These thresholds are applied per one-way flight. For round trips, system evaluates
              segment prices separately or combined (depending on configuration).
            </span>
                    </div>
                </div>
            </div>
            ...
            <div className="card p-4 space-y-3 text-sm">
                ...
                <div className="grid md:grid-cols-3 gap-4 text-xs">
                    ...
                    <div className="text-[11px] text-slate-600 md:col-span-2">
                        This helps steer employees towards business-friendly departure times (e.g. avoid night
                        flights) without fully blocking out-of-window options.
                    </div>
                </div>
            </div>
            ...
            <div className="card p-4 grid md:grid-cols-2 gap-4 text-sm">
                ...
                <div className="space-y-2">
                    ...
                    <div className="text-xs text-slate-600 space-y-1">
                        <div>
                            Connections:{' '}
                            <strong>{allowConnections ? 'Allowed' : 'Forbidden'}</strong>
                            {allowConnections && ` (max ${maxConnectionTime} minutes per connection)`}
                        </div>
                        <div>
                            Hand baggage only:{' '}
                            <strong>{handBaggageOnly ? 'Required' : 'Not required'}</strong>
                        </div>
                        <div className="text-[11px] text-slate-500 mt-1">
                            These rules are applied on top of price and time logic and are reflected in flight
                            badges and detailed tooltips in search results.
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div className="card p-4 space-y-3 text-sm">
                ...
                <div className="flex flex-col md:flex-row gap-3 text-xs">
                    <LegendItem
                        ...
                        title="OK"
                        text="Ticket fully fits policy by price, time window and class. Green badge in search results."
                    />
                    <LegendItem
