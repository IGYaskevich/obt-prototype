        ...
        switch (company.tariff) {
            ...
            case 'POSTPAY':
                return {
                    ...
                    description:
                        'Email and ticket/chat support within business hours. Typical response: 2–4 hours.',
            ...
            default:
                return {
                    ...
                    description:
                        'Priority chat, phone and WhatsApp 24/7. Typical response: under 15 minutes.',
        ...
        <div className="space-y-6">
            ...
            <div className="card p-4 grid md:grid-cols-3 gap-4 text-sm">
                <div className="flex items-start gap-2">
                    ...
                    <div>
                        <div className="font-semibold flex items-center gap-2">
                            ...
                            <span
                                className={`px-2 py-0.5 rounded-full text-[10px] border ${supportLevel.badgeClass}`}
                            >
                ...
                <div className="text-xs text-slate-500 flex items-start gap-2">
                    ...
                    <span>
            This is a demo. All actions here (chat, WhatsApp, ticket creation) are simulated with
            alerts, but they mimic real B2B OBT support flows.
          </span>
                </div>
            </div>
            ...
            <div className="card p-4 grid md:grid-cols-3 gap-4 text-sm">
                            ...
                            <>
                                ...
                                <div className="mt-2 flex flex-wrap gap-2">
                                    <button
                                        ...
                                        onClick={() =>
                                            alert(
                                                'Simulated: open in-app chat widget. In real product this would open chat panel.'
                                            )
                                        }
                                    >
                                    ...
                                    <button
                                        ...
                                        onClick={() =>
                                            alert(
                                                'Simulated: open WhatsApp link: https://wa.me/77001234567 (support number).'
                                            )
                                        }
                                    >
                                        WhatsApp
                    ...
                    {company.tariff === 'FLEX'
                        ...
                        : 'Business hours, local time'}
                            ...
                            <div className="text-[11px] text-slate-500">
                                Chat and WhatsApp support are available for Postpay and Flex tariffs. For Free
                                tariff, please use email and FAQ below.
                            </div>
                        )}
                    </div>
                </div>
                ...
                <div className="space-y-2 text-xs">
                    ...
                    <div className="text-slate-600">
                        <div>
                            Send us an email with full details (PNR, dates, passenger names, problem
                            description).
                        </div>
                        <div className="mt-2">
              <span className="font-mono text-[12px] bg-slate-50 px-2 py-1 rounded border border-slate-200">
                ...
                <div className="space-y-2 text-xs">
                    ...
                    {isPhoneAvailable ? (
                        ...
                        <div className="text-[11px] text-slate-500">
                            Priority phone line is available for Flex tariff. On Free/Postpay, main contact
                            channels are email and chat.
                        </div>
                    )}
                </div>
            </div>
                ...
                <div className="md:col-span-2 space-y-3 text-xs">
                    ...
                    <div>
                        <label className="text-[11px] text-slate-500">
                            Short description (what happened, for which booking)
                        </label>
                        <textarea
...
function FAQ({ tariff }: { tariff: 'FREE' | 'POSTPAY' | 'FLEX' }) {
    ...
    const items = FAQ_ITEMS.filter(
        item => !item.tariffs || item.tariffs.includes(tariff)
    )

    if (!items.length) {
        return (
            <div className="text-xs text-slate-500">
                No FAQ items for this tariff in prototype.
            </div>
        )
    }
        ...
        <div className="space-y-2 text-xs">
            {items.map(item => (
              ...
              {openId === item.id ? '−' : '+'}
                    ...
                    {openId === item.id && (
                        <div className="px-3 pb-3 text-[11px] text-slate-600">{item.a}</div>
                    )}
                </div>
            ))}
        </div>
