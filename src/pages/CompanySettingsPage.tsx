    ...
    <div className="space-y-6">
      ...
      <div className="card p-4 grid md:grid-cols-3 gap-4 text-sm">
        ...
        <div className="text-xs text-slate-600 flex items-start gap-2">
          ...
          <span>
            Company profile is used across invoices, acts and internal reports. In this prototype we keep it local,
            without real backend updates.
          </span>
        </div>
          ...
          {company.corporateCard ? (
            ...
            <>
              <div className="text-xs text-slate-600">
                No corporate card is linked yet. In real onboarding, card binding is done during first purchase or
                registration. Here you can simulate binding.
              </div>
      ...
      <div className="card p-4 space-y-4 text-sm">
        <div className="flex items-center justify-between">
          ...
          {!canManageSettings && (
            <span className="text-[11px] text-slate-400">Read-only in this prototype for non-admin roles</span>
          )}
        </div>
          ...
          <div className="flex items-start gap-2">
            ...
            <div>
              ...
              <div className="text-[11px] text-slate-600 mt-1">
                Rules below define OK / WARN / BLOCK flags in flight search and booking. Read-only version is available
                on Travel Policy page.
              </div>
            </div>
          </div>
        ...
        <div className="border-t border-slate-100 pt-3 mt-2 space-y-3">
          ...
          <div className="grid md:grid-cols-3 gap-4 text-xs">
            ...
            <div className="text-[11px] text-slate-500 flex items-start gap-2">
              ...
              <span>
                Soft limit = WARN threshold. Block limit = red zone, ticket cannot be purchased if price is above this
                value.
              </span>
            </div>
          </div>
        ...
        <div className="border-t border-slate-100 pt-3 mt-2 grid md:grid-cols-2 gap-4 text-sm">
          ...
          <div className="space-y-2">
            ...
            <div className="text-[11px] text-slate-500">
              These rules are applied in addition to price and time conditions and are reflected in flight badges and
              tooltips.
            </div>
          </div>
        </div>
      ...
      <div className="card p-4 space-y-3 text-sm">
        <div className="flex items-center justify-between">
          ...
          {!canManageTariff && (
            <span className="text-[11px] text-slate-400">Tariff changes allowed for admin only</span>
          )}
        </div>
        <div className="grid md:grid-cols-3 gap-3 text-xs">
          <TariffCard
